                ...
                "<li id='vstId_" + id + "' viewshedId='" + id + "'>",
                    ...
                    "<div class='vstShedContents' style='border-left: 6px solid " + initObj.color + ";'>",
                        ...
                        "<div class='vstOptionOpacity'>",
                            "<div>Opacity</div>",
                            "<input class='slider2' type='range' min='0' max='1' step='0.01' aria-label='Viewshed opacity' value='" + initObj.opacity + "' default='0.5'>",
                        "</div>",
                        ...
                        "<div class='vstOptionHeight'>",
                            ...
                            "<div class='flexbetween'>",
                                "<input type='number' min='0' step='1' aria-label='Observer height' value='" + initObj.height + "' default='2'>",
                        ...
                        "<div class='vstOptionTargetHeight'>",
                            ...
                            "<div class='flexbetween'>",
                                "<input type='number' min='0' step='1' aria-label='Target height' value='" + initObj.targetHeight + "' default='0'>",
                                "<div class='vstUnit smallFont'>m</div>",
                            "</div>",
                        "</div>",
                        "<div class='vstOptionFOVAzimuth'>",
                            ...
                            "<div class='flexbetween'>",
                                "<input type='number' min='0' max='360' step='1' aria-label='FOV azimuth' value='" + initObj.FOVAzimuth + "' default='360'>",
                        ...
                        "<div class='vstOptionFOVElevation'>",
                            ...
                            "<div class='flexbetween'>",
                                "<input type='number' min='0' max='180' step='1' aria-label='FOV elevation' value='" + initObj.FOVElevation + "' default='180'>",
                                "<div class='vstUnit'>&deg;</div>",
                            "</div>",
                        "</div>",
                        "<div class='vstOptionCenterAzimuth'>",
                            ...
                            "<div class='flexbetween'>",
                                "<input type='number' step='6' aria-label='Center azimuth' value='" + initObj.centerAzimuth + "' default='0'>",
                                "<div class='vstUnit'>&deg;</div>",
                            "</div>",
                        "</div>",
                        "<div class='vstOptionCenterElevation'>",
                            ...
                            "<div class='flexbetween'>",
                                "<input type='number' min='-90' max='90' step='1' aria-label='Center elevation' value='" + initObj.centerElevation + "' default='0'>",
                                "<div class='vstUnit'>&deg;</div>",
                            "</div>",
                        "</div>",
                        "<div class='vstOptionLatitude'>",
                            "<div>Latitude</div>",
                            "<div class='flexbetween'>",
                                "<input type='number' min='0' max='180' step='1' aria-label='Latitude' value='" + initObj.latitude + "' default='0'>",
                                "<div class='vstUnit'>&deg;</div>",
                            "</div>",
                        "</div>",
                        "<div class='vstOptionLongitude'>",
                            "<div>Longitude</div>",
                            "<div class='flexbetween'>",
                                "<input type='number' min='0' max='180' step='1' aria-label='Longitude' value='" + initObj.longitude + "' default='0'>",
                                "<div class='vstUnit'>&deg;</div>",
                            "</div>",
                        "</div>",
